...
let ClientsController = class ClientsController {
    ...
    async deactivateClient(id, req) {
        return this.clientsService.deactivateClient(id, req.user);
    }
    async reactivateClient(id, req) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ClientsController.prototype, "deactivateClient", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ClientsController.prototype, "reactivateClient", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ClientsController.prototype, "getStatement", null);
exports.ClientsController = ClientsController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Controller)('crediApi/clients'),
